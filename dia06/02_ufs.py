...
type(str_to_float(numero))

# %%

# Converter valores de uma coluna para inteiro (um por um)
...
# Convertendo strings da coluna Expectativa de vida para float
...
# Criando um coluna nova que diz qual região o estado está (CASE WHEN no python)
...
uf['classificação'] = uf.apply(classifica_bom, axis=1)
uf
